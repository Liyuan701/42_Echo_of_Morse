      ...
      <div className="mx-auto max-w-4xl px-6 py-10 text-gray-800 leading-7">
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            ...
            of our platform, including Morse code learning tools,
            competitions, leaderboards, and messaging features.
          </p>
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            ...
            By using Echoes of Morse, you confirm that you meet this requirement.
          </p>
        </section>
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            Access to the platform requires authentication via GitHub OAuth
            or 42 OAuth.
          </p>
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            We reserve the right to remove scores, suspend accounts,
            or reset rankings in cases of cheating, abuse,
            or technical issues.
          </p>
        </section>
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            Users may communicate through private chat features.
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            All platform content, design, logos, and learning materials are
            the property of Morse Team unless otherwise stated.
          </p>
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            We strive to maintain continuous access to the platform,
            but we do not guarantee uninterrupted service.
          </p>

          <p>
            The platform may be modified, suspended, or discontinued
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            Echoes of Morse is provided "as is" without warranties
            of any kind.
          </p>

          <p>
            Morse Team shall not be liable for data loss,
            service interruptions, or damages arising from the use
            of the platform.
          </p>
        </section>
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            ...
            that violate these Terms or threaten platform security.
          </p>
        </section>
